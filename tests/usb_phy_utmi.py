...
class UsbPhyUtmi(UsbPhy):
    ...
    def __init__(self, rxd, rxa, rxdv, rxer, txd, txv, txrdy, ls, xcvrsel, termsel, clock,
        ...
        super(UsbPhyUtmi, self).__init__('UsbPhyUtmi', rxd, rxa, rxdv, rxer, txd, txv, txrdy, ls, xcvrsel, termsel, clock,
