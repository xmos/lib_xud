...
typedef enum USBEventType { tx, rx, delay};
...
void usb_tick(node *head)
{
    ...
    drive_port("stdcore[0]", "XS1_PORT_1A", 0x1, g_usbClock);
...
int main(int argc, char **argv)
{
    ...
    USBEvent *test0 = new USBRxPacket(RX_DATALENGTH, data);
    USBEvent *test1 = new USBDelay(12);
