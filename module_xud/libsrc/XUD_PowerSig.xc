...
int XUD_Suspend()
{
    ...
    unsigned devAddr;
        ...
        {
            char wData[] = {0};
            read_glx_periph_word(GLXID, XS1_GLX_PERIPH_USB_ID, XS1_UIFM_DEVICE_ADDRESS_REG, devAddr);
         ...
         while(1)
        {
            ...
            { 
                ...
                write_glx_periph_word(GLXID, XS1_GLX_PERIPH_USB_ID, XS1_UIFM_DEVICE_ADDRESS_REG, devAddr);
